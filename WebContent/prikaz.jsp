...
<title>WarezBB ~ Forum view</title>
	...
	<div id="okvir1">
		...
		<%
			try {
					...
					int brstrprikaz = (Integer) request.getAttribute("brstr");
					Tema tema = dao.selectTemaID(por.get(0).getIdtema());
					String imeforum = (String) sesija.getAttribute("ime-foruma");
		%>
		<div id="levi_deo1">
			<div id="dugme_tema">
				<a style="text-decoration: none;"
					href="ServletProsledi?idpor=<%=por.get(0).getIdtema()%>">Odgovori</a>
			</div>
			<div id="holder_forum_naslov"><%=tema.getTema()%></div>

			<a href="index.jsp">Pocetna</a> >>><a href="tema.jsp">Forum:<%=imeforum%>
			</a>>>>Tema:<%=tema.getTema()%>
			...
			<div id="holder_poruka">
				...
				<div id="holder-poruka-opis"><%=pom.getPoruka()%></div>
